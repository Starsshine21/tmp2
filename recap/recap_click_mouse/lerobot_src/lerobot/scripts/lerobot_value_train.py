...
def value_train(
    ...
    if accelerator is None:
        ...
        # Pistar06 backbones expose modules (for example pooler heads) that are not
        # used by the scalar-value loss. Multi-GPU DDP must explicitly tolerate
        # those parameters; this does not change the loss or optimizer updates.

...
class PandaClickMouseGymEnv(MujocoGymEnv):
    ...
    def __init__(
        ...
        self._deterministic_rendering = bool(deterministic_rendering)
        super().__init__(
            xml_path=_XML_PATH,
            seed=seed,
        ...
        if self._deterministic_rendering:
            # EGL multisample resolve can vary slightly across fresh OpenGL
            # contexts. Strict paired evaluation uses one sample so identical
            # simulator states produce bitwise-identical camera observations.

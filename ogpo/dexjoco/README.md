...
- [OGPO JAX Full Finetuning](#ogpo-jax-full-finetuning)
- [Headless Rendering](#headless-rendering)
- [License](#-license)
- [Citation](#-citation)

## OGPO JAX Full Finetuning

The experimental OGPO path trains a calibrated multimodal U-DIVL critic in
PyTorch and full-finetunes the native JAX PI0.5 actor with PPO, reference KL,
flow matching, and success-buffer regularization.

- [Implementation and current status](docs/ogpo_implementation_zh.md)
- [Runbook](docs/ogpo_runbook_zh.md)
- [Algorithm and paper derivation](docs/ogpo_paper_derivation_zh.md)

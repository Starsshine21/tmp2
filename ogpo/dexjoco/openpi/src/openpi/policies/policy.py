...
class Policy(BasePolicy):
    ...
    def infer(self, obs: dict, *, noise: np.ndarray | None = None) -> dict:  # type: ignore[misc]
        ...
        policy_noise_seed = inputs.pop("_policy_noise_seed", None)
        request_noise = inputs.pop("_policy_noise", None)
        ...
        if noise is None and policy_noise_seed is not None:
            noise = np.asarray(
                jax.random.normal(
                    jax.random.key(int(policy_noise_seed)),
